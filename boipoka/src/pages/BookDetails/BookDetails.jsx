...
const BookDetails = () => {
  ...
  // localstorage set ,,addtodb
  const handleMarkAsRead = (id) => {
    // store with id
    // where to store
    // array or collection
    // if bok already exist the show a alart
  ...
  const shortReview =
    review.length > 250 ? review.slice(0, 250) + "..." : review;
    ...
    <div className="container mx-auto my-12 px-5 md:px-10 lg:px-24">
      <div className="flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          <h1 className="text-4xl lg:text-5xl font-bold text-[#131313] mb-3">
            {bookName}
          </h1>
          ...
          <div className="flex gap-5">
            <button
              ...
              className="btn btn-outline border-[#1313134d] px-10 hover:bg-[#131313] hover:text-white rounded-xl text-lg font-semibold transition-all"
            >
              Read
            </button>
